...
public class MainActivity extends AppCompatActivity {
    ...
    private JSONArray imagenDeInicio;




    private  interrupcionAdapter interrupcionAdapter;
    ArrayList<HashMap> arrayListPrueba;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterViewFlipperPublicidad.setAutoStart(true);
            ...
            //int id = R.layout.item_grid;



            //View view = inflater.inflate(id,null,false);
            //TextView textView = (TextView) view.findViewById(R.id.itemGrid_Tv_nombre);


            //linearLayout.addView(interrupcionAdapter);
    ...
    private void llenarGridView(){
        ...
        gridView = (GridView) findViewById(R.id.main_GV_productos);
        adapter = new AdapterGrid(this,arrayList);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                intent.putExtra("PRICE",adapter.getItem(i).toString());
    ...
    private JSONArray obtenerCategorias(){
